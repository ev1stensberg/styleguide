    ...
    return (
        <FocusBox>
            <div className="focus-box-with-labels">
                <div className={
                    cn('focus-box-with-labels__upper-left', 'focus-box-with-labels__item', {
                ...
                <div className={
                    cn('focus-box-with-labels__upper-right', 'focus-box-with-labels__item', {
                ...
                <div className={
                    cn('focus-box-with-labels__bottom-left', 'focus-box-with-labels__item', {
                ...
                <div className={
                    cn('focus-box-with-labels__bottom-right', 'focus-box-with-labels__item', {
